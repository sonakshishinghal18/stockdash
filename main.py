...
# Allow the user's GitHub Pages origin — set FRONTEND_URL env var on Render
...
async def search_stocks(q: str = Query(..., min_length=1)):
    """Proxy Yahoo Finance search autocomplete."""
...
async def get_news(ticker: str):
    """Proxy Yahoo Finance RSS news feed."""
...
async def analyze_stock(req: AnalyzeRequest):
    """Call Gemini for AI stock analysis. Returns structured JSON."""
